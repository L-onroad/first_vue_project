  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ correctUser.fullAddress }}</span>
        收货人：<span>{{ correctUser.consignee }}</span
        >&nbsp;
        <span>{{ correctUser.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: this.correctUser.consignee,
        consigneeTel: this.correctUser.phoneNum,
        deliveryAddress: this.correctUser.fullAddress,
        paymentWay: "ONLINE",
